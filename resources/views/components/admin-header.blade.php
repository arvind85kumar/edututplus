...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" title="Logout" href="{{url('logout')}}" role="button">
...
<!-- Student Menu Start here -->
   @if(Auth::user()->role_id == '2')
            <li class="nav-item">
                <a href="{{url('online-classes')}}" class="nav-link">
    ...
    <!-- /.End Student Menu-->
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('link-student')}}" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('all-meetings')}}" class="nav-link">
                  <i class="fa fa-tv nav-icon"></i>
                  <p>All Meetings</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('new-meeting')}}" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="new-patient" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('doctor-list')}}" class="nav-link">
              ...
              <li class="nav-item">
                <a href="{{url('shops-list')}}" class="nav-link">
                  <i class="fas fa-medkit nav-icon"></i>
                  <p>Pharmacy</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('lab-list')}}" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('all-tests')}}" class="nav-link">
